...
from rdkit.Chem.rdchem import BondType as RDChemBondType

from funcbind.utils.evaluation import eval_bond_length_config
...
BOND_TYPES = {
    RDChemBondType.UNSPECIFIED: 0,
    RDChemBondType.SINGLE: 1,
    RDChemBondType.DOUBLE: 2,
    RDChemBondType.TRIPLE: 3,
    RDChemBondType.AROMATIC: 4,
}
