# from https://github.com/guanjq/targetdiff/blob/main/utils/evaluation/scoring_func.py
...
from funcbind.utils.evaluation.sascorer import compute_sa_score
...
def get_diversity(fp_ref, fingerprints):
